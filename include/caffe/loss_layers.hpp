...
private:
  ...
  public:
    BoundingBox() {
      xmin = ymin = xmax = ymax = confidence = -1;
    }
    BoundingBox(Dtype xmin, Dtype ymin, Dtype xmax, Dtype ymax, Dtype confidence)
        : xmin(xmin), ymin(ymin), xmax(xmax), ymax(ymax), confidence(confidence){}
    ~BoundingBox() {}
